...
export function ProgramCard({ title, desc, gradient }: ProgramCardProps) {
  return (
    <div
      className="relative col-span-1 flex flex-col justify-between overflow-hidden rounded-3xl border border-white/18 bg-white/10 p-7 md:p-8 lg:col-span-5 lg:p-9 backdrop-blur-2xl shadow-[0_18px_50px_rgba(0,0,0,0.55)] transition-transform hover:scale-[1.02]"
